...
int main(int argc, const char** argv) {
  if (argc < 2) {
    ...
    const string sceneName = baseName.substr(baseName.find_last_of("/"));
    ...
    const string segFilePrefix = argv[4];
    string segFile = segFilePrefix + sceneName + "." + std::to_string(kthr) + ".segs.json";
